...
guestList2.forEach((guests) => console.log(`Salam ${guests}, I would like to invite you to dinner, it would be a great pleasure if you came.`));
...
guestList2.forEach((lasttwo) => console.log(`Luckily ${lasttwo}, you two are still invited`));
...
let guestLength = guestList3.length;
console.log(guestLength);
//  Question 20 solution:
let speakingLanguages = ["Urdu", "English", "Pashto", "French"];
